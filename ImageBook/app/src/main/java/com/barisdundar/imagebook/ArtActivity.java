package com.barisdundar.imagebook;
...
import com.barisdundar.imagebook.databinding.ActivityArtBinding;
...
ActivityResultLauncher<String> permissionLauncher; //izin istemek için
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.matches("new")) {
            ...
            Bitmap selectImage = BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.images);
        ...
        activityResultLauncher = registerForActivityResult(
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == ArtActivity.RESULT_OK) {
